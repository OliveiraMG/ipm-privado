...
class SincronizarPermissoesPerfilComponent {
    ...
    render() {
      ...
      const permissionOptions = [
        'Importação', 'Estatísticas', 'Malha Fiscal', 'Monitoramento', 'ICMS Cota Parte',
        'Cadastro', 'Relatórios', 'Atividades Econômicas', 'Auxiliares', 'Acessos',
        'Configurações', 'Importar', 'Importados', 'Visualizar Remessas', 'Cadastrar Remessas',
        'Editar Remessas', 'Remover Remessas', 'Visualizar Publicações', 'Cadastrar Publicações',
        'Editar Publicações', 'Visualizar Exercícios', 'Cadastrar Exercícios', 'Editar Exercícios',
        'Remover Exercícios', 'Visualizar Filas', 'Visualizar Falhas'
      ];
      ...
      if (syncBtn) {
        syncBtn.addEventListener('click', () => {
          this.selectedPermissions = Array.from(checkboxes)
            ...
            .map(cb => cb.value);
          toast.success(`Permissões de ${this.perfilName} sincronizadas com sucesso!`);
      ...
      checkboxes.forEach(checkbox => {
        checkbox.addEventListener('change', (e) => {
          ...
          if (e.target.checked) {
            ...
            this.selectedPermissions = this.selectedPermissions.filter(p => p !== value);
          }
        });
      });
    }
