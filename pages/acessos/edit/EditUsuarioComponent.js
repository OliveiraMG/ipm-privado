      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        <div class="col-span-1">
          ...
          <select id="tipo" name="tipo"
            ...
            <option value="Desenvolvedor" ${this.usuarioData.tipoUsuario === 'Desenvolvedor' ? 'selected' : ''}>Desenvolvedor</option>
            <option value="Administrador" ${this.usuarioData.tipoUsuario === 'Administrador' ? 'selected' : ''}>Administrador</option>
            <option value="Contabilista" ${this.usuarioData.tipoUsuario === 'Contabilista' ? 'selected' : ''}>Contabilista</option>
            <option value="Prefeitura" ${this.usuarioData.tipoUsuario === 'Prefeitura' ? 'selected' : ''}>Prefeitura</option>
          </select>
        </div>
        <div class="col-span-1">
        ...
        <div class="col-span-1">
          ...
          <select id="ativo" name="ativo"
                  class="mt-1 block w-full border border-gray-300 rounded-md p-2 text-sm focus:ring-blue-light focus:border-blue-light">
            <option value="Sim" ${this.usuarioData.ativo === 'Sim' ? 'selected' : ''}>SIM</option>
            <option value="Não" ${this.usuarioData.ativo === 'Não' ? 'selected' : ''}>NÃO</option>
          </select>
        </div>
        <div class="col-span-1">
          ...
          <select id="cidade" name="cidade"
                  class="mt-1 block w-full border border-gray-300 rounded-md p-2 text-sm focus:ring-blue-light focus:border-blue-light">
            <option value="São Paulo" ${this.usuarioData.cidade === 'São Paulo' ? 'selected' : ''}>São Paulo</option>
            <option value="Rio de Janeiro" ${this.usuarioData.cidade === 'Rio de Janeiro' ? 'selected' : ''}>Rio de Janeiro</option>
            <option value="Belo Horizonte" ${this.usuarioData.cidade === 'Belo Horizonte' ? 'selected' : ''}>Belo Horizonte</option>
            <option value="Pontes e Lacerda" ${this.usuarioData.cidade === 'Pontes e Lacerda' ? 'selected' : ''}>Pontes e Lacerda</option>
          </select>
        </div>
        <div class="col-span-1">
        ...
        <div class="col-span-2 flex items-center space-x-4">
          <div>
            ...
            <img id="foto-preview" src="${this.usuarioData.foto || 'https://via.placeholder.com/50'}" alt="Foto do usuário"
