  ...
  openPrintModal() {
    const printComponent = new PrintCfopComponent({
      onPrint: (filters) => {
        ...
        if (filters.descricao)
          printMessage += `- Descrição: ${filters.descricao}\n`;
        if (filters.aplicacao)
          printMessage += `- Aplicação: ${filters.aplicacao}\n`;
    ...
    const cfops = [
      {
        ...
        aplicacao:
          "Classifica-se neste código as outras saídas de mercadorias ou prestações de serviços que não tenham sido especificadas nos códigos anteriores.",
      },
      {
        cfop: 7930,
        descricao:
        ...
        aplicacao:
          "Classifica-se neste código os lançamentos efetuados a título de saída em devolução de bens cuja entrada tenha ocorrido sob amparo de regime especial aduaneiro de admissão temporária.",
      },
      {
        cfop: 7667,
        descricao:
        ...
        aplicacao:
          "Classifica-se neste código a venda de combustível ou lubrificante a consumidor ou usuário final, cuja operação tenha sido efetuada por estabelecimento distribuidor ou varejista, a partir de 05/2009 - a partir de 01/07/2010 - Decreto nº 34.490/2009). Ajuste SINIEF 05/2009.",
      },
      {
        cfop: 7654,
        descricao:
        ...
        aplicacao:
          "Classifica-se neste código a venda de combustível ou lubrificante adquiridos ou recebidos de terceiros, destinada a comercialização, a partir de 01.01.2004 - Decreto nº 26.174 de 26/11/2003.",
      },
      {
        cfop: 7651,
        descricao:
        ...
        aplicacao:
          "Classifica-se neste código a venda de combustível ou lubrificante de produção do estabelecimento, destinados a comercialização, a partir de 01.01.2004 - Decreto nº 26.174 de 26/11/2003.",
      },
      {
        cfop: 7556,
        descricao: "Devolução de compra de material de uso ou consumo.",
        aplicacao:
          "Classifica-se neste código as devoluções de mercadorias destinadas ao uso ou consumo do estabelecimento, cuja entrada tenha sido classificada no código 3.556 - Compra de material para uso ou consumo.",
      },
      {
        cfop: 7553,
        descricao: "Devolução de compra de bem para o ativo imobilizado.",
        aplicacao:
          "Classifica-se neste código as devoluções de bens adquiridos para integrar o ativo imobilizado do estabelecimento, cuja entrada foi classificada no código 3.551 - Compra de bem para o ativo imobilizado.",
      },
    ];
