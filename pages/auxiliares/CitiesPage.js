...
class CitiesPage {
  ...
  openDistrictsModal(cityId) {
    ...
    toast.info(
      `Visualizando distritos de "${cityData.cidade}"... (Funcionalidade não implementada)`
    );
  ...
  printData(filters) {
    ...
    if (filters.codigo) {
      filteredData = filteredData.filter(
        (item) => item.codigo === filters.codigo
      );
    }
    ...
    if (filters.ativo !== null) {
      filteredData = filteredData.filter(
        (item) => item.ativo === (filters.ativo ? "Sim" : "Não")
      );
    }
            ...
            <tbody>
              ${filteredData
                ...
                <tr>
                  ...
                  <td>${
                    item.brasao
                      ? `<img src="${item.brasao}" alt="Brasão" width="32" height="32" />`
                      : "-"
                  }</td>
                </tr>
              `
    ...
    toast.success(
      `${filteredData.length} cidade(s) preparada(s) para impressão.`
    );
  }
          ...
          <tr class="bg-white">
            <td class="text-center py-2 px-4">
              <div class="flex space-x-2 justify-center">
                ...
                <button class="districts-btn bg-gray-500 text-white text-xs rounded px-2 py-1" data-id="${
                  row.id || ""
                }" style="display: inline-block !important;">
            ...
            <td class="text-center py-2 px-4">
              ${
                row.brasao
                  ? `<img src="${row.brasao}" alt="Brasão" class="h-8 w-8 mx-auto" />`
                  : "-"
              }
            </td>
          </tr>
  ...
  setupTableButtonEvents() {
    ...
    districtsButtons.forEach((button) => {
      console.log(
        "Binding event to districts button with data-id:",
        button.getAttribute("data-id")
      ); // Debug log
      button.addEventListener("click", () => {
        const cityId = parseInt(button.getAttribute("data-id"));
    ...
    const cidades = [
      {
        ...
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-acorizal.png",
      },
      {
        codigo: 10006,
        cidade: "ÁGUA BOA",
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-agua-boa.png",
      },
      {
        codigo: 15008,
        ...
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-alta-floresta.png",
      },
      {
        codigo: 20001,
        ...
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-alto-araguaia.png",
      },
      {
        codigo: 23000,
        ...
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-alto-boa-vista.png",
      },
      {
        codigo: 25003,
        cidade: "ALTO GARÇAS",
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-alto-garcas.png",
      },
      {
        codigo: 30007,
        ...
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-alto-paraguai.png",
      },
      {
        codigo: 32000,
        cidade: "ALTO TAQUARI",
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-alto-taquari.png",
      },
      {
        codigo: 33006,
        cidade: "APIACÁS",
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-apiacas.png",
      },
      {
        codigo: 34002,
        cidade: "ARAGUAINHA",
        estado: "Mato Grosso",
        ativo: "Não",
        brasao: "/images/brasao-araguainha.png",
      },
    ];
