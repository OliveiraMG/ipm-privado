/**
 * IndiceMunicipioPage.js - Página de Lotes Gerados
 */
import ModalComponent from "../../../components/common/ModalComponent.js";
import { Header } from "../../../components/layout/Header.js";

class IndiceMunicipioPage {
  constructor() {
    this.tableData = [];
    this.modal = null;
    this.currentPage = 1;
  ...
  initialize() {
    console.log("Inicializando IndiceMunicipioPage...");
    Header.initialize();
  ...
  static initialize() {
    return new IndiceMunicipioPage();
  }
}

document.addEventListener("DOMContentLoaded", () => {
  IndiceMunicipioPage.initialize();
});

export default IndiceMunicipioPage;
