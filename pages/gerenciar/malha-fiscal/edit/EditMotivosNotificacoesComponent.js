/**
 * EditMotivoComponent.js - Componente para edição de CFOP
 */
class EditMotivosNotificacoesComponent {
          ...
          <form id="edit-cfop-form" class="space-y-4">
            <div class="grid grid-cols-3 gap-4">
              <div class="col-span-1">
                ...
                <input type="text" id="cfop" name="cfop" value="${
                  this.cfopData.cfop || ""
              ...
              <div class="col-span-2">
                ...
                <textarea id="descricao" name="descricao" rows="3" class="mt-1 block w-full border border-gray-300 rounded-md p-2 text-sm" required>${
                  this.cfopData.descricao || ""
                }</textarea>
              </div>
            </div>
            <div>
              <label for="aplicacao" class="block text-sm font-medium text-gray-700">Aplicação*</label>
              <textarea id="aplicacao" name="aplicacao" rows="3" class="mt-1 block w-full border border-gray-300 rounded-md p-2 text-sm" required>${
                this.cfopData.aplicacao || ""
              }</textarea>
            </div>
...
export default EditMotivosNotificacoesComponent;
