/**
 * OmissosPage.js - Página de Listagem de Omissos
 */
...
class OmissosPage {
  ...
  initialize() {
    console.log("Inicializando OmissosPage...");
    Header.initialize();
    ...
    if (breadcrumbContainer) {
      breadcrumbContainer.innerHTML = `
        <div class="pt-1 pb-1 pl-4 pr-4 md:pl-20 md:pr-16">
          <div class="text-gray-500 text-base leading-tight">Cadastro | Contribuinte | Omissos</div>
          <div class="text-blue-dark font-semibold text-2xl md:text-4xl leading-tight mt-0">Omissos</div>
        </div>
      `;
    }
  }
  ...
  static initialize() {
    return new OmissosPage();
  }
}

document.addEventListener("DOMContentLoaded", () => {
  OmissosPage.initialize();
});

export default OmissosPage;
