/**
 * VaPositivosPage.js - Página de VA Positivos
 */
import ModalComponent from "../../../components/common/ModalComponent.js";
import { Header } from "../../../components/layout/Header.js";

class VaPositivosPage {
  constructor() {
    this.tableData = [];
    this.modal = null;
    this.currentPage = 1;
  ...
  initialize() {
    console.log("Inicializando VaPositivosPage...");
    Header.initialize();
    ...
    if (breadcrumbContainer) {
      breadcrumbContainer.innerHTML = `
        <div class="pt-1 pb-1 pl-4 pr-4 md:pl-20 md:pr-16">
          <div class="text-gray-500 text-base leading-tight">Cadastro | Contribuinte | VA Positivos</div>
          <div class="text-blue-dark font-semibold text-2xl md:text-4xl leading-tight mt-0">VA Positivos</div>
        </div>
      `;
    }
  }
...
`;
  ...
  static initialize() {
    return new VaPositivosPage();
  }
}

document.addEventListener("DOMContentLoaded", () => {
  VaPositivosPage.initialize();
});

export default VaPositivosPage;
