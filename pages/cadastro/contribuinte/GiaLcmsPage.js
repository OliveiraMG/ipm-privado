/**
 * GiaLcmsPage.js - Página de Lotes Gerados
 */
...
class GiaLcmsPage {
  ...
  initialize() {
    console.log("Inicializando GiaLcmsPage...");
    Header.initialize();
    ...
    if (breadcrumbContainer) {
      breadcrumbContainer.innerHTML = `
        <div class="pt-1 pb-1 pl-4 pr-4 md:pl-20 md:pr-16">
          <div class="text-gray-500 text-base leading-tight">Cadastro | Contribuinte | GIA ICMS Lançamentos</div>
          <div class="text-blue-dark font-semibold text-2xl md:text-4xl leading-tight mt-0">GIA ICMS Lançamentos</div>
        </div>
      `;
    }
  }
...
`;
  ...
  static initialize() {
    return new GiaLcmsPage();
  }
}

document.addEventListener("DOMContentLoaded", () => {
  GiaLcmsPage.initialize();
});

export default GiaLcmsPage;
