/**
 * VaNegativosPage.js - Página de VA Negativos
 */
import ModalComponent from "../../../components/common/ModalComponent.js";
import { Header } from "../../../components/layout/Header.js";

class VaNegativosPage {
  constructor() {
    this.tableData = [];
    this.modal = null;
    this.currentPage = 1;
  ...
  initialize() {
    console.log("Inicializando VaNegativosPage...");
    Header.initialize();
    ...
    if (breadcrumbContainer) {
      breadcrumbContainer.innerHTML = `
        <div class="pt-1 pb-1 pl-4 pr-4 md:pl-20 md:pr-16">
          <div class="text-gray-500 text-base leading-tight">Cadastro | Contribuinte | VA Negativos</div>
          <div class="text-blue-dark font-semibold text-2xl md:text-4xl leading-tight mt-0">VA Negativos</div>
        </div>
      `;
    }
  }
...
`;
  ...
  static initialize() {
    return new VaNegativosPage();
  }
}

document.addEventListener("DOMContentLoaded", () => {
  VaNegativosPage.initialize();
});

export default VaNegativosPage;
