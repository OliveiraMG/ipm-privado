/**
 * EfdLancamentosPage.js - Página de Lançamentos EFD
 */
import ModalComponent from "../../../components/common/ModalComponent.js";
import { Header } from "../../../components/layout/Header.js";

class EfdLancamentosPage {
  constructor() {
    this.tableData = [];
    this.modal = null;
    this.currentPage = 1;
  ...
  initialize() {
    console.log("Inicializando EfdLancamentosPage...");
    Header.initialize();
    ...
    if (breadcrumbContainer) {
      breadcrumbContainer.innerHTML = `
        <div class="pt-1 pb-1 pl-4 pr-4 md:pl-20 md:pr-16">
          <div class="text-gray-500 text-base leading-tight">Cadastro | Contribuinte | EFD Lançamentos</div>
          <div class="text-blue-dark font-semibold text-2xl md:text-4xl leading-tight mt-0">EFD Lançamentos</div>
        </div>
      `;
    }
  }
...
`;
  ...
  static initialize() {
    return new EfdLancamentosPage();
  }
}

document.addEventListener("DOMContentLoaded", () => {
  EfdLancamentosPage.initialize();
});

export default EfdLancamentosPage;
