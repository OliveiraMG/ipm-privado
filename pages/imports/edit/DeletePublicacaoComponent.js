...
class DeletePublicacaoComponent {
  constructor(config) {
    this.publicacaoData = config.publicacaoData || {};
  ...
  render() {
    ...
    message.innerHTML = `
      <p class="text-gray-700">Deseja remover essa Publicação do Sistema?</p>
      <p class="text-gray-700 font-medium">${this.publicacaoData.descricao}</p>
    `;
...
export default DeletePublicacaoComponent;