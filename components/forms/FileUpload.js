...
class FileUpload {
    ...
    render() {
      ...
      container.className = 'flex items-center border border-gray-300 rounded-lg overflow-hidden';
      ...
      fileNameDisplay.className = 'flex-grow px-4 py-2 outline-none text-gray-700';
      container.appendChild(fileNameDisplay);
      
      // Botão para escolher arquivo
      const chooseButton = document.createElement('button');
      chooseButton.type = 'button';
      chooseButton.className = 'bg-blue-medium hover:bg-blue-dark text-white px-4 py-2 transition-colors';
