...
class Pagination {
  ...
  render() {
    ...
    prevButton.className =
      "px-2 py-1 text-gray-600 hover:text-gray-900 border border-gray-300 rounded-l-md";
    ...
    pagesToShow.forEach((page, index) => {
      if (page === "...") {
        ...
        ellipsis.className =
          "px-3 py-1 border-t border-b border-r border-gray-300 text-gray-600";
    ...
    nextButton.className =
      "px-2 py-1 text-gray-600 hover:text-gray-900 border border-gray-300 border-l-0 rounded-r-md";
