...
class ChartComponent {
    ...
    render() {
      ...
      this.container.innerHTML = `
        <div class="mb-6">
          ${this.title ? `<h3 class="text-xl font-medium text-blue-dark mb-4 mt-20">${this.title}</h3>` : ''}
    ...
    renderEmptyState() {
      this.container.innerHTML = `
        <div class="mb-6">
          ${this.title ? `<h3 class="text-xl font-medium text-blue-dark mb-4">${this.title}</h3>` : ''}
          <div class="bg-white rounded-[16px] shadow-[6px_6px_12px_rgba(0,0,0,0.25)] p-6">
            <div class="text-center py-8">
              <i class="fas fa-chart-${this.type === 'line' ? 'line' : 'bar'} text-4xl text-gray-300 mb-4"></i>
